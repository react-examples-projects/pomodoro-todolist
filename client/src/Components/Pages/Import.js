    ...
    <LayoutPage>
      <div className="w-80">
        ...
        <Typography.Paragraph>
          Puedes importar notas y tareas desde un archivo JSON que hayas
          exportado anteriormente. Asegurate de no mofidicar su contenido para
          que no exista errores durante el proceso de importanción del archivo y
          en la escritura de los datos.
        </Typography.Paragraph>
